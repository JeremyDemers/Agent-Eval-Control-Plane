.PHONY: setup format lint typecheck test test-unit test-property test-contract test-integration test-e2e package demo sdk-demo sandbox-demo ollama-demo openai-demo service-demo serve worker db-start db-stop db-status docker-build docker-demo podman-build podman-demo clean
